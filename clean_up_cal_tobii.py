...
try:
    copyfile('eye_gaze_data_cal_tobii.csv',path+'\\'+user_name+'_eye_gaze_data_cal_tobii.csv')
    print('coppied eye gaze data cal')
    os.remove('eye_gaze_data_cal_tobii.csv')
except:
...
try:
    copyfile('frame_angles_cal_tobii.csv',path+'\\'+user_name+'_frame_angles_cal_tobii.csv')
    print('copied frame angles cal')
    os.remove('frame_angles_cal_tobii.csv')
except:
