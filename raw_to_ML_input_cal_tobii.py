...
input_raw_eye_data_filename='eye_gaze_data_cal_tobii.csv'
output_pixel_coordinate_data_filename='video_gazed_cal.csv'
...
with open(input_raw_eye_data_filename,'r') as csvfile:
    ...
    for row in gaze_reader:
        if first_row:
            ...
            if row[10]=='nan' or row[11]=='nan':
                left_xs_raw.append(float(0))
                left_ys_raw.append(float(0))
                left_zs_raw.append(float(0))
                
                right_xs_raw.append(float(0))
                right_ys_raw.append(float(0))
                right_zs_raw.append(float(0))            

                combined_xs_raw.append(float(0))
                combined_ys_raw.append(float(0))
                combined_zs_raw.append(float(0))               
...
with open(output_pixel_coordinate_data_filename, 'w') as csvfile:
    ...
    for frame in range(0,len(frame_nums)):
        ...
        left_xs[frame]=video_rez_x*left_xs[frame]
        if left_xs[frame]<0:
            left_xs[frame]=0
        ...
        left_ys[frame]=video_rez_y*left_ys[frame]
        if left_ys[frame]<0:
            left_ys[frame]=0
        ...
        right_xs[frame]=video_rez_x*right_xs[frame]
        if right_xs[frame]<0:
            right_xs[frame]=0
        ...
        right_ys[frame]=video_rez_y*right_ys[frame]
        if right_ys[frame]<0:
            right_ys[frame]=0
        ...
        combined_xs[frame]=video_rez_x*combined_xs[frame]
        ...
        combined_ys[frame]=video_rez_y*combined_ys[frame]
